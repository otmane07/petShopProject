...
<%@include file="header.jsp" %>
       ...
       <c:forEach items="${products}" var="p">
                        <c:if test="${ p.getProduct_status().equals('spec')}"> 
                   
        	<div class="feat_prod_box">
            
            		<div class="prod_img"><a href="details.do?id=${p.getProduct_id()}"><img src="images/${p.getPet_images()}" alt="" title="" border="0" /></a></div>
