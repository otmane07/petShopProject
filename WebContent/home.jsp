<%@include file="header.jsp" %>
       ...
       <div class="center_content">
       	<div class="left_content">
            ...
            <div class="title"><span class="title_icon"><img src="images/bullet1.gif" alt="" title="" /></span>Featured pets</div>
        	 ...
        	 <c:forEach items="${products}" var="p">
                     ...
                     <c:if test="${ p.getProduct_id()%5==0}"> 
		               
	              
                   		    
                    <div class="feat_prod_box">
            
            	<div class="prod_img"><a href="details.do?id=${p.getProduct_id()}"><img src="images/${p.getProduct_images()}" alt="" title="" border="0" /></a></div>
                
                <div class="prod_det_box">
                	<div class="box_top"></div>
                    <div class="box_center">
                    <div class="prod_title">${p.getProduct_name()}</div>
                    <p class="details">${p.product_description}</p>
                    <a href="details.do?id=${p.getProduct_id()}" class="more">- more details -</a>
                    <div class="clear"></div>
                    </div>
           ...
           <div class="new_products">
             		 ...
             		 <c:forEach items="${products}" var="p">
             		 <c:if test="${ p.getProduct_status().equals('new')}"> 
